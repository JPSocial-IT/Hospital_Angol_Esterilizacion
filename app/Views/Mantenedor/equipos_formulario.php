<form name="FormEquipo" id="FormEquipo" role="form" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="mb-2 row">
            <label for="txt_descripcion" class="col-md-4 col-form-label">Nombre del Equipo :</label>
            <div class="col-md-8">
        ...
        <div class="mb-2 row">
            ...
            <span class="text-danger font-side-11">(* Requerido)</span>
            <select class="form-select" name="val_tipo_id" id="val_tipo_id" tabindex="5" placeholder=".col-xs-3" onchange="funcion_t(this);">
                <option></option>
                    <?php
        ...
        <div class="mb-2 row">
            <label for="txt_tipo_descripcion" class="col-md-4 col-form-label">Descripción Tipo Equipo :</label>
            <div class="col-md-8">
                <input type="text" name="txt_tipo_descripcion" id="txt_tipo_descripcion" class="form-control"  placeholder="Descripcion tipo de Equipo" value="<?php echo $resultado['tipo_descripcion'] ;?>" tabindex="6">
            </div>
        </div>
        <div class="mb-2 row">
            <label for="val_centro_costo" class="col-md-4 col-form-label">Centro Costo :</label>
            <div class="col-md-8">
                <input type="text" name="val_centro_costo" id="val_centro_costo" class="form-control"  placeholder="Centro Costos Contable" value="<?php echo $resultado['centro_costo'] ;?>" tabindex="7">
            </div>
        </div>
    </div>
...
<script>
function funcion_t(e) {
    var option = e.options[e.selectedIndex];
    var inputAux = document.getElementById('inputAux');
    $encargado=option.text;
    document.getElementById("txt_tipo_descripcion").value = option.text;
    /* alert("Valor Option: " + option.value + ", Texto Option: " + $encargado); */
    alert("Valor Input: " + inputAux.value);}
</script>
