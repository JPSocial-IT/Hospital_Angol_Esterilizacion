...
<table class="table table-success table-striped table align-middle table-nowrap mb-0 dt-responsive">
    ...
    <thead class="thead-dark">
        <tr>
            ...
            <th class="align-middle">Tipo Equipo</th>
    ...
    ?>
        <tr>
            ...
            <td data-id="<?php echo $row['id'];?>" id="td_acciones_<?php echo $row['id'];?>">
                <button type="button" class="btn btn-primary btn_editar btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title data-bs-original-title="Editar Equipo #<?php echo $row['id'];?>" onclick="editarEquipo(<?php echo $row['id'];?>);">
                    <i class="mdi mdi-pencil me-1"></i>
                </button>
                <button type="button" class="btn btn-danger btn_eliminar btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title data-bs-original-title="Eliminar Equipo #<?php echo $row['id'];?>" onclick="eliminarEquipo(<?php echo $row['id'];?>);">
