...
<html lang="es">
    ...
    <?php echo $this->include('partials/body'); ?>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <!-- <h4 class="card-title mb-4"><?= lang('Files.Mantenedor Demo Listado')?></h4>         -->
                                                <h4 class="card-title mb-4"><?= lang('Files.Mantenedor Estados Solicitudes')?></h4>
                                            </div>
        ...
        <!-- <script src="assets/js/proyecto/mantenedor_demo.js"></script> -->
        <script src="assets/js/proyecto/estados_solicitudes.js"></script>
    </body>
</html> 